    ...
    Given a feature named "response.feature" with:
      ...
      Feature: Response Steps
        ...
        Scenario: I should see
          ...
          Then I should see "Page #34"

        Scenario: I should not see
          Given I should not see "Page #34"
          When I go to /behat/tests/page/page34
          Then I should not see "Page #1"
          And I should not see "Page #34"
      ...
      """
    When I run "./console behat:test:feature %features_path%/response.feature -f progress --no-colors --no-time"
