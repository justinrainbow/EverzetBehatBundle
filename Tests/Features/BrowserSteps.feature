Feature: Browser Steps
    ...
    Given a feature named "browser.feature" with:
      ...
      Feature: Browser Steps
        ...
        Scenario: I click
          ...
          Then I should see "Page #0"
          And I should not see "Page #1"

        Scenario: Unexistent click
          Given I should see "Page #1"
          When I click "p100" link
          Then I should see "Page #100"

        Scenario: Backward
          Given I click the "p22" link
          And I should see "Page #22"
          When I go back
        ...
        Scenario: Forward
          ...
          When I go back
          And I go forward
          Then I should see "Page #22"
      """
    When I run "./console behat:test:feature %features_path%/browser.feature -f progress --no-colors --no-time"
    ...
    Given a feature named "redirect.feature" with:
      ...
      Feature: Redirects
        ...
        Scenario:
          ...
          Then I should see "Page #1"
      """
    When I run "./console behat:test:feature %features_path%/redirect.feature -f progress --no-colors --no-time"
    Then It should fail with:
      """
      ..F-....
  ...
  Scenario: POST|PUT|DELETE sends
    Given a feature named "send.feature" with:
      ...
      """
    When I run "./console behat:test:feature %features_path%/send.feature -f progress --no-colors --no-time"
